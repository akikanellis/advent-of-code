...
[discussions](https://github.com/akikanellis/advent-of-code/discussions) to see
if it's already being discussed, or
you can help us
by [submitting an issue](https://github.com/akikanellis/advent-of-code/issues).
...
1. Fork the project
    ...
    2. [Fork](https://docs.github.com/en/get-started/quickstart/fork-a-repo)
        the [main repository](https://github.com/akikanellis/advent-of-code)
...
7. [Open a PR](https://github.com/akikanellis/advent-of-code/pulls). We use the
